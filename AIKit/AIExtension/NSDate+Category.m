 ...
 *  English version
 */
- (NSString *)timeIntervalEnDescription
{
    ...
    if (timeInterval < 60) {
        ...
        return [NSString stringWithFormat:@"%.f hour ago", timeInterval / 3600];
    } else if (timeInterval < 2592000) {//30天内
        return [NSString stringWithFormat:@"%.f day ago", timeInterval / 86400];
    } else if (timeInterval < 31536000) {//30天至1年内
        //        NSDateFormatter *dateFormatter = [NSDateFormatter dateFormatterWithFormat:@"M月d日"];
        //        return [dateFormatter stringFromDate:self];
        
        return [NSString stringWithFormat:@"%@ %ldth",self.Month,(long)self.day];
    } else {
        return [NSString stringWithFormat:@"%.f year ago", timeInterval / 31536000];
    }
}
